...
// Cek apakah pengunjung sudah pernah membuka halaman ini dalam sesi yang sama
if (sessionStorage.getItem("hasVisited")) {
  // Jika SUDAH pernah berkunjung, langsung hapus loader tanpa animasi
  if (loader) {
    loader.style.display = "none";
    loader.remove();
  }
} else {
  // Jika BELUM pernah berkunjung, jalankan animasi loading seperti biasa
  let value = 0;
  ...
  const loading = setInterval(() => {
    ...
    if (value >= 100) {
      ...
      // Simpan tanda bahwa pengunjung sudah pernah melihat loading
